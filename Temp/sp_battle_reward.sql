...
BEGIN
    ...
    begin
        ...
        insert into heros select SLOT1 from GT_TEAMs where TEAM_ID = 1 and UUID = p_UUID and SLOT1 <> 0;
        insert into heros select SLOT2 from GT_TEAMs where TEAM_ID = 1 and UUID = p_UUID and SLOT2 <> 0;
        insert into heros select SLOT3 from GT_TEAMs where TEAM_ID = 1 and UUID = p_UUID and SLOT3 <> 0;
        insert into heros select SLOT4 from GT_TEAMs where TEAM_ID = 1 and UUID = p_UUID and SLOT4 <> 0;        
