...
(function (exports) {
	...
	inst.BT_HERO_EVOLUTION_STATUS = function (sequelize, path, callback) {
		base_table = sequelize.define('BT_HERO_EVOLUTION_STATUS', {
				...
				for (var i in read.Rows) {
					(function (i) {
						...
						.success(function (anotherTask) {
							...
							if (read.Rows.length - 1 == i && typeof callback == 'function') callback('BT_HERO_EVOLUTION_STATUS');
						})
						.error(function (err) {
							console.log(err);
						});
