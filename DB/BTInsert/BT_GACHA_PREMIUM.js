...
(function (exports) {
	...
	inst.BT_GACHA_PREMIUM = function (sequelize, path, callback) {
		base_table = sequelize.define('BT_GACHA_PREMIUM', {
				...
				for (var i in read.Rows) {
					(function (i) {
						...
						.success(function (anotherTask) {
							...
							if (read.Rows.length - 1 == i && typeof callback == 'function') callback('BT_GACHA_PREMIUM');
						})
						.error(function (err) {
							console.log(err);
						});
