...
(function (exports) {
	...
	inst.BT_SHOP_CHALLENGE = function (sequelize, path, callback) {
		base_table = sequelize.define('BT_SHOP_CHALLENGE', {
				...
				for (var i in read.Rows) {
					(function (i) {
						...
						.success(function (anotherTask) {
							...
							if (read.Rows.length - 1 == i && typeof callback == 'function') callback('BT_SHOP_CHALLENGE');
						})
						.error(function (err) {
							console.log(err);
						});
